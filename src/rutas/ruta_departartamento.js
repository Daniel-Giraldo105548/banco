...
enrutador.put('/actualizar/:id_departamento', controlador_departamento.actualizarDepartamento);
enrutador.delete('/borrar/:id_departamento', controlador_departamento.borrarDepartamento);
